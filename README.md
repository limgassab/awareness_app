...
**Inner Path / Chemin intérieur** is a bilingual, installable personal-growth journal. It helps a person choose a simple intention in the morning, record meaningful moments during the day, and reflect briefly in the evening.
...
For a difficult moment, the user can optionally start a short reset. Available actions include breathing slowly, taking a short walk, pausing in silence, writing, praying or reflecting, talking to someone, or choosing a personal action.
...
- **Check-in / Noter**: record a moment using text, photo, or audio.
...
```js
const CACHE_NAME = 'inner-path-cache-v1';
```
...
The working product name in this repository is **Inner Path / Chemin intérieur**. A trademark and marketplace search should be completed before using the name commercially.
